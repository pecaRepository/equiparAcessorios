angular.module('Paginationapp', []).directive('dirPaginate', ['$compile', '$parse', '$timeout', 'paginationService', function($compile, $parse, $timeout, paginationService) {
    return  {
...
.directive('dirPaginationControls', ['paginationService', function(paginationService) {
    ...
    return {
        ...
        templateUrl: function(elem, attrs) {
            return attrs.templateUrl || 'pages/cliente/dirPagination.tpl.jsp';
        },
        scope: {
            maxSize: '=?',
            onPageChange: '&?'
