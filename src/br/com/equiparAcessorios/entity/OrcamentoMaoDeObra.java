...
@Entity
@Table(name="ORCAMENTO_MAO_OBRA")
public class OrcamentoMaoDeObra {
	
	@Id
	@SequenceGenerator(name="S_ORCAMENTO_MAO_OBRA", sequenceName="S_ORCAMENTO_MAO_OBRA", initialValue=1, allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "S_ORCAMENTO_MAO_OBRA")
	@Column(name="CD_H_MO")
